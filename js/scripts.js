...
"Modern+Times","Sweet+Smell+Of+Success","Ace+In+THe+Hole","Face+In+The+Crowd","Roma","Sunset+Boulevard","Toni+Erdmann","The+Man+Who+Shot+Liberty+Valance","The+Big+Sleep", "This+Gun+For+Hire","On+The+Waterfront","Roman+Holiday","Dog+Day+Afternoon","Pickup+On+South+Street","The+Entertainer","Il+vangelo+secondo+Matteo","Onibaba","Murder,+My+Sweet","Ascenseur+Pour+léchafaud","Kind+Hearts+And+Coronets","La+Règle+Du+Jeu","Ikiru","Amarcord",
