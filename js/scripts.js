...
var ourFilms=["Yojimbo","In+A+Lonely+Place","Lazzaro+Felice","Casablanca","Double+Indemnity","Dersu+Uzala","Bringing+Up+Baby","Twelve+Angry+Men","The+Seventh+Seal","The+Apartment","Winchester+73","High+Noon","Harold+And+Maud","The+Third+Man","Coming+Home","Otto+e+mezzo","Il+Bidone",
...
"Who's+Afraid+Of+Virginia+Woolf?","Ugetsu","Wild+Strawberries","African+Queen","Butch+Cassidy+And+The+Sundance+Kid","La+Strada","The+Circus","I+Vitelloni","Pickpocket","Stagecoach","Midnight+Cowboy","The+White+Sheik","Sherlock+Jr","The+Big+Heat","His+Girl+Friday","Cairo+Station","Umberto+D","The+Last+Detail","Pigs+And+Battleships","The+Roaring+Twenties","Long+Days+Journey+Into+Night" ]
alert(ourFilms.length)
var exceptionIds = [5156, 247, 20530, 12493,  346,14168,42691,11645,307,31589,18148,17295,14537,3777,17409,28528];
var exceptionTitles = ['bicycle theives', 'The Killing', 'Late Spring', 'High and Low', 'Seven Samurai', 'Ran','Oedipus rex','rome open city','the bad sleep well','Tokyo Story','The Battle of Algiers','Harakiri','Throne of blood','The Gunfighter','the harder they fall'];
