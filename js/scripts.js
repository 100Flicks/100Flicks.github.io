...
"Who's+Afraid+Of+Virginia+Woolf?","A+Streetcar+Named+Desire","Ugetsu","Wild+Strawberries","African+Queen","Butch+Cassidy+And+The+Sundance+Kid","La+Strada","Shampoo","The+Circus","Nosferatu","I+Vitelloni","Pickpocket","Zatoichi","Stagecoach","Midnight+Cowboy","The+White+Sheik","The+Shop+Around+The+Corner","Being+There","City+Lights","Sherlock+Jr","The+Big+Heat","The+Desperate+Hours","His+Girl+Friday","Cairo+Station","Umberto+D","Gun+Crazy","The+Good+The+Bad+And+The+Ugly","The+Last+Detail","Serpico","Grand+Hotel","Les+Enfants+Du+Paradis","Pigs+And+Battleships","The+Roaring+Twenties","Long+Days+Journey+Into+Night" ]

var exceptionIds = [5156,670, 247, 20530, 12493,  346,14168,42691,64828,11645,307,31589,18148,17295,14537,3777,17409,28528];
var exceptionTitles = ['bicycle theives','Oldboy', 'The Killing', 'Late Spring', 'High and Low', 'Seven Samurai', 'Ran','Oedipus rex','the landlord','rome open city','the bad sleep well','Tokyo Story','The Battle of Algiers','Harakiri','Throne of blood','The Gunfighter','the harder they fall'];
